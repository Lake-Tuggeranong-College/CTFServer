# Template - Windmill Module

> [!WARNING]
> This page is out of date. It is a sample document to show how to and what to write for the configration of a module. It may not reflect the current state of the windmill module. Please refer to the code and wiring diagram for the most up-to-date information.
...
![Windmill Module Wiring Diagram](images/wiringWindmill.png)
